...
- 💎 My current favorite projects are <a href="https://github.com/cintnguyen/first-auth-imageboard?tab=readme-ov-file#readme" target="_blank">Image Board</a>, an app inspired by **Pinterest** and my love for storytelling through images ; [EventHub](https://github.com/cintnguyen/demo-eventhub?tab=readme-ov-file#readme), an app that seamlessly combines AI-generated to-do lists, text reminders, a centralized platform for shared images, and integration with Google Maps API for directions, revolutionizing event planning and organization
